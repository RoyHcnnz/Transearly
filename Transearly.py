...
async def translate(interaction: discord.Interaction, text: str):
    ...
    replyEmbed = discord.Embed(title=result["result"][0]["text"])
    replyEmbed.set_author(name=author.display_name, icon_url=author.avatar.url)
    replyEmbed.add_field(name="original reply", value=text)
    replyEmbed.set_footer(text="The transalation is generated by a third party tool and hence may NOT be accurate.")
    
    await cache.message.reply(embed=replyEmbed)
